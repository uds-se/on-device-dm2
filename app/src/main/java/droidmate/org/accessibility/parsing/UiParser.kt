...
import droidmate.org.accessibility.extensions.markedAsOccupied
import droidmate.org.accessibility.extensions.toByteArray
import droidmate.org.accessibility.extensions.toRect
import droidmate.org.accessibility.extensions.toRectangle
import droidmate.org.accessibility.extensions.visibleAxis
import droidmate.org.accessibility.extensions.visibleAxisR
...
import droidmate.org.accessibility.utils.safeCharSeqToString
...
abstract class UiParser {
	...
	protected suspend fun createBottomUp(
		w: DisplayedWindow, node: AccessibilityNodeInfo, index: Int = 0,
	...
	private fun AccessibilityNodeInfo.createWidget(
		w: DisplayedWindow, xPath: String, children: List<UiElementProperties>,
		img: Bitmap?, idHash: Int, parentH: Int, processedNodes: List<UiElementProperties>
	): UiElementProperties {
		val nodeRect = Rect()
